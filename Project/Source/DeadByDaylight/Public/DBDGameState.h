...
public:
    ...
    UPROPERTY(Transient, ReplicatedUsing=OnRep_ActivatedGeneratorCount, BlueprintReadWrite, EditAnywhere)
    int32 _activatedGeneratorCount;
    
    UPROPERTY(Transient, ReplicatedUsing=OnRep_RequiredActivatedGeneratorCount, BlueprintReadWrite, EditAnywhere)
    int32 _requiredActivatedGeneratorCount;
    
    UPROPERTY(Transient, ReplicatedUsing=OnRep_EscapeDoorActivated, BlueprintReadWrite, EditAnywhere)
    bool _escapeDoorActivated;
    
    UPROPERTY(Replicated, Transient, BlueprintReadWrite, EditAnywhere)
    bool _escapeDoorOpened;
    
    UPROPERTY(Transient, ReplicatedUsing=OnRep_HatchOpened, BlueprintReadWrite, EditAnywhere)
    bool _isHatchOpen;
    ...
    UPROPERTY(Transient, ReplicatedUsing=OnRep_SurvivorLeft, BlueprintReadWrite, EditAnywhere)
    int32 _survivorLeft;
    ...
    UPROPERTY(Transient, ReplicatedUsing=OnRep_ObsessionTarget, BlueprintReadWrite, EditAnywhere)
